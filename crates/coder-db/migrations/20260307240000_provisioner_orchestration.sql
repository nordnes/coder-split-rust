...
-- Enum types (provisioner_type, provisioner_storage_method, provisioner_job_type,
-- provisioner_job_status, log_source, log_level, provisioner_job_timing_stage)
-- are defined in 20260307230000_enum_types.sql.
